...
class DMPs(object):
    ...
    def rollout(self,  **kwargs):
        ...
        f_learned = np.zeros((timesteps,self.n_dmps))
        for t in range(timesteps):

            # run and record timestep
            y_track[t], dy_track[t], ddy_track[t], f_learned[t,:]= self.step(**kwargs)

        return y_track, dy_track, ddy_track, f_learned
    ...
    def step(self, tau=1.0, error=0.0, external_force=None):
        ...
        return self.y, self.dy, self.ddy, f_learn
